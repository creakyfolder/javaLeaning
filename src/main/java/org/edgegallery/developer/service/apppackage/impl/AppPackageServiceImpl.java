...
public class AppPackageServiceImpl implements AppPackageService {
    ...
    @Override
    public AppPackage generateAppPackage(VMApplication application, EnumAppPackageType appPackageType) {
        ...
        String fileName = vmPackageFileCreator.generateAppPackageFile(appPackageType);
