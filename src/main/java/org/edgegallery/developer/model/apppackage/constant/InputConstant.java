...
public class InputConstant {
    ...
    public static final String COMPUTE_NAME_PREFIX = "compute_res";

    public static final String VDU_NAME_PREFIX = "VDU";

    public static final String VDU_SIZE_SUFFIX = "_SIZE";
    ...
    public static final String INPUT_MEM_POSTFIX = "_mem_";

    public static final String INPUT_MEM_DES_POSTFIX = "_Mem_Size";

    public static final String INPUT_VCPU_POSTFIX = "_cpu_";
    ...
    public static final String INPUT_DATADISK_SIZE_POSTFIX = "_Size";
