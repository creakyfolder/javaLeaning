...
public class VMPackageFileCreator extends PackageFileCreator {
    ...
    public String generateAppPackageFile(EnumAppPackageType appPackageType) {
        ...
        configMetaFile();
        configVnfdMeta();
        generateAPPDYaml(appPackageType);
    ...
    private boolean generateAPPDYaml(EnumAppPackageType appPackageType) {
        String appdFilePath = getAppdFilePath();
        AppDefinitionConverter converter = new AppDefinitionConverter();
        AppDefinition appDefinition = converter.convertApplication2Appd(this.application, appPackageType);
